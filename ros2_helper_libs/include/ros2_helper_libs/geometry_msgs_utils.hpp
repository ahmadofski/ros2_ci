...
Point make_point(const double &x = 0.0, const double &y = 0.0,
                 const double &z = 0.0);

Quaternion make_quaternion(const double &w = 1.0, const double &x = 0.0,
...
Pose make_pose(const double &p_x, const double &p_y, const double &p_z,
               const double &q_w = 1.0, const double &q_x = 0.0,
               const double &q_y = 0.0, const double &q_z = 0.0);
...
inline void apply_to_members(BinaryOperator op, const Point &lhs,
                             const Point &rhs, Point &res) {
...
template <class BinaryOperator>
inline Point apply_to_members(BinaryOperator op, const Point &lhs,
                              const Point &rhs) {
  Point res;
