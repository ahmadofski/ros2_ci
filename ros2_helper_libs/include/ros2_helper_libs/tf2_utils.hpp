...
void transform_to_local(geometry_msgs::msg::Point &target,
                        const geometry_msgs::msg::Pose &local_frame);

//! convert point into local frame
void convert_to_local(geometry_msgs::msg::Point &local,
                      const geometry_msgs::msg::Point &global,
                      const geometry_msgs::msg::Pose &local_frame);

//! convert point into global frame
void convert_to_global(const geometry_msgs::msg::Point &local,
